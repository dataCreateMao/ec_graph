...
class TableSynchronizer:
    ...
    def sync_base_category1(self):
       ...
       """
        ...
        self.neo4j_writer.write_nodes(label="Category1", properties=self.mysql_reader.read(sql))
    ...
    def sync_base_category2(self):
       ...
       FROM base_category2
       """
        self.neo4j_writer.write_nodes(label="Category2", properties=self.mysql_reader.read(sql))
    ...
    def sync_base_category3(self):
       ...
       FROM base_category3
       """
        self.neo4j_writer.write_nodes(label="Category3", properties=self.mysql_reader.read(sql))
    ...
    def sync_category1_category2(self):
       ...
       """
        ...
        self.neo4j_writer.write_relations(start_label="Category2",
                                              end_label="Category1",
                                              relations=relations,
                                              type='Belong')
    ...
    def sync_category2_category3(self):
       ...
       """
        ...
        relations = self.mysql_reader.read(sql)
        self.neo4j_writer.write_relations(start_label="Category3",
                                              end_label="Category2",
                                              relations=relations,
                                              type='Belong')
    ...
    def sync_base_attr(self):
       ...
       FROM base_attr_info
       """
        self.neo4j_writer.write_nodes(label="BaseAttr", properties=self.mysql_reader.read(sql))
        ...
        base_attr_category3 = [
            {
                "start_id": r['start_id'],
                "end_id": r['end_id']
            } for r in relations if r['category_level'] == 3
        ]
        self.neo4j_writer.write_relations(start_label="Category3",
                                              end_label="BaseAttr",
                                              relations=base_attr_category3,
                                              type='Have')
        ...
        base_attr_category2 = [
            {
                "start_id": r['start_id'],
                "end_id": r['end_id']
            } for r in relations if r['category_level'] == 2
        ]
        self.neo4j_writer.write_relations(start_label="Category2",
                                              end_label="BaseAttr",
                                              relations=base_attr_category2,
                                              type='Have')
        ...
        base_attr_category1 = [
            {
                "start_id": r['start_id'],
                "end_id": r['end_id']
            } for r in relations if r['category_level'] == 1
        ]
        self.neo4j_writer.write_relations(start_label="Category1",
                                              end_label="BaseAttr",
                                              relations=base_attr_category1,
                                              type='Have')
    ...
    def sync_base_attr_value(self):
       ...
       """
        self.neo4j_writer.write_nodes(label="BaseAttrValue", properties=self.mysql_reader.read(sql))
    ...
    def sync_base_attr_value_attr(self):
       ...
       """
        relations = self.mysql_reader.read(sql)
        self.neo4j_writer.write_relations(start_label="BaseAttr",
    ...
    def sync_spu(self):
       ...
       from spu_info
       """
        self.neo4j_writer.write_nodes(label="SPU", properties=self.mysql_reader.read(sql))
    ...
    def sync_sale_attr(self):
       ...
       from spu_sale_attr
       """
        self.neo4j_writer.write_nodes(label="SaleAttr", properties=self.mysql_reader.read(sql))
    ...
    def sync_sale_attr_value(self):
       ...
       """
        self.neo4j_writer.write_nodes(label="SaleAttrValue", properties=self.mysql_reader.read(sql))
    ...
    def sync_sale_attr_value_attr(self):
       ...
       """
        relations = self.mysql_reader.read(sql)
        self.neo4j_writer.write_relations(start_label="SaleAttr",
    ...
    def sync_sku(self):
       ...
       from sku_info
       """
        self.neo4j_writer.write_nodes(label="SKU", properties=self.mysql_reader.read(sql))
    ...
    def sync_sku_base_attr_value(self):
       ...
       """
        relations = self.mysql_reader.read(sql)
        self.neo4j_writer.write_relations(start_label="SKU",
                                              end_label="BaseAttrValue",
                                              relations=relations,
                                              type='Have')
